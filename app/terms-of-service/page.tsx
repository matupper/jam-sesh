  ...
  return (
    <ThemedContainer className="container mx-auto py-[35px] px-4">
      ...
      <div className="mx-auto mt-6 w-full max-w-[1100px] rounded-md bg-white p-8 text-left shadow-sm">
        <h1 className="mb-2 text-xl font-semibold">TERMS OF USE</h1>
        <p>Last updated on March 1, 2025</p>

        <h2 className="mt-6 mb-2 text-lg font-semibold">AGREEMENT TO TERMS</h2>
        <p>
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (“you”) and AFOL,
          Inc. (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or
          “our&quot;), concerning your access to and use of the Marjin website
          or web application (
          <Link href=" https://afol.com">https://afol.com</Link>) as well as any
        ...
        <p>
          AFOL® and AFOL.com™ are trademarks of AFOL, Inc. AFOL.com is not
          affiliated with, authorized, sponsored, or endorsed by The LEGO Group.
          LEGO® is a trademark of the LEGO Group of companies. Any usage of the
          LEGO® trademark is strictly for descriptive purposes. The LEGO Group
          does not sponsor, endorse, or authorize this site or its content. All
          other trademarks and copyrights are the property of their respective
          owners. This content is created for informational and entertainment
          purposes only, and no infringement is intended. If any trademark or
          copyright holder believes their rights have been infringed, please
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">FEES AND PAYMENT</h2>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">CANCELLATION</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">SUBMISSIONS</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">SITE MANAGEMENT</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">GOVERNING LAW</h2>
        <p>
          These Terms shall be governed by and defined following the laws of the
          State of Oregon in the United States of America. The Company and
          yourself irrevocably consent that the courts of the State of Oregon
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">
          Cannabis Laws Compliance
        </h2>
        <p>
          This site is not liable for any compliance violations with regard to
          state cannabis laws. The users of this site acknowledge that it is
          their sole responsibility to ensure that they are compliant with all
          applicable state laws related to cannabis. We shall not be responsible
          or liable for any consequences that may arise from a user&apos;s
          non-compliance with these laws.
        </p>
        <br />

        <h2 className="mt-6 mb-2 text-lg font-semibold">DISPUTE RESOLUTION</h2>
        ...
        <p>
          ...
          provided below) informally for at least ninety days before initiating
        ...
        <p>
          ...
          this clause. The number of arbitrators shall be three. The seat, or
          legal place, of arbitration shall be Portland, Oregon. The language to
          be used in the arbitral proceedings shall be English. The governing
          law of the contract shall be the substantive law of the State of
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">CORRECTIONS</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">DISCLAIMER</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">INDEMNIFICATION</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">USER DATA</h2>
        <p>
        ...
        <h2 className="mt-6 mb-2 text-lg font-semibold">MISCELLANEOUS</h2>
        <p>
